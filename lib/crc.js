module.exports.ASANTE_INITIAL_REMAINDER = 0xFFFF;
module.exports.ASANTE_FINAL_XOR_VALUE = 0x0000;
module.exports.DEXCOM_INITIAL_REMAINDER = 0x0000;
module.exports.DEXCOM_FINAL_XOR_VALUE = 0x0000;
 ...
 * Returns:     The CRC of the buffer.
 *********************************************************************/
module.exports.calcAsanteCRC = function (bytes, size) {
  return this.calcCRC(bytes, size,
                               this.ASANTE_INITIAL_REMAINDER,
                               this.ASANTE_FINAL_XOR_VALUE);
};
 ...
 * Returns:     The CRC of the buffer.
 *********************************************************************/
module.exports.calcDexcomCRC = function (bytes, size) {
  return this.calcCRC(bytes, size,
                               this.DEXCOM_INITIAL_REMAINDER,
                               this.DEXCOM_FINAL_XOR_VALUE);
};

module.exports.testAsanteCRC = function (s) {
  ...
  console.log(bytes);
  var acrc = this.calcAsanteCRC(bytes, s.length);
  console.log("Asante CRC (decimal) = ", acrc);
  return acrc;
};

module.exports.testDexcomCRC = function (s) {
  var buf = new ArrayBuffer(s.length);
  bytes = new Uint8Array(buf);
  for (var i = 0; i < s.length; ++i) {
    bytes[i] = s.charCodeAt(i);
  ...
  console.log(bytes);
  var dcrc = this.calcDexcomCRC(bytes, s.length);
