    ...
    if (parsed != null) {
      ...
      if (bolus != null) {
        ...
        if (wizard == null) {
          ...
          // we assign the wizard time to the bolus to avoid potential sequencing violations
          // see test/carelink/bolus/normal/withWizardInterveningBG for an example
          simulator.wizard(cleanEvent(wizard), {bolus: _.assign({type: 'bolus'}, bolus, {time: wizard.time})});
        }
      }
    }
  };
