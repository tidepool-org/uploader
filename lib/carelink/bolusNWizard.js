  ...
  return function (simulator, datum, i, data) {
    ...
    if (parsed != null) {
            ...
            incrementProcessedIndexUntil(data, processedIndex, function(e){
              if (uploadId === e.uploadId) {
                ...
                if (e.type === 'bolusSquare' && e.dualComponent &&
                    (wizard != null && seq === wizard.uploadSeqNum - 2) &&
                    seq === bolus.uploadSeqNum - 1) {
                  square = cleanEvent(e);
                }
                ++processedIndex;
                return true;
            ...
            incrementProcessedIndexUntil(data, processedIndex, function(e){
              if (uploadId === e.uploadId) {
                ...
                if (e.type === 'bolusNormal' && e.dualComponent &&
                    (wizard != null && seq === wizard.uploadSeqNum - 1) &&
                    seq === bolus.uploadSeqNum + 1) {
                  normal = cleanEvent(e);
                }
                ++processedIndex;
      ...
      if (bolus.extended === bolus.expectedExtended) {
        ...
        bolus.duration = Math.floor((bolus.extended / (bolus.expectedExtended * 1.0)) * bolus.duration);
      }
      ...
      if (wizard == null) {
        ...
        simulator.wizard(cleanEvent(wizard), {bolus: bolus});
      }
    }
  };
};
