    ...
    for (i = data.length - 1; i >= 0; --i) {
      ...
      switch (type) {
        ...
        case 'CurrentInsulinSensitivityPattern':
          ...
          for (; i < data.length-1 && data[i]['Raw-Type'].indexOf('Current') === 0; ++i) { /* increment i to end of Current */ }
          var beginningOfCurrent = i;
          while (beginningOfCurrent >= 0 && data[beginningOfCurrent]['Raw-Type'].indexOf('Current') === 0) {
            --beginningOfCurrent;
          }
          ++beginningOfCurrent;
          ...
          for (j = beginningOfCurrent; j <= i; ++j) {
          ...
          cachedObjects.unshift(_.assign({}, commonParser(findSettingsChangeBefore(beginningOfCurrent)), settings));
          i = beginningOfCurrent;
          break;
        case 'ChangeBolusWizardSetup':
          switch (type) {
            case 'ChangeActiveBasalProfilePattern':
