...
exports.makeCommonVals = function(){
  return function (line) {
    ...
    return {
      ...
      clockDriftOffset: line.clockDriftOffset,
      conversionOffset: line.conversionOffset,
      deviceId: line[RAW_DEVICE_TYPE] + '-=-' + line[RAW_UPLOAD_ID],
      index: line.index,
      // TODO: delete after conclusion of Jaeb study
      jaebPayload: {
        rawSeqNums: [line[RAW_SEQ_NUM]],
        rawUploadId: line[RAW_UPLOAD_ID]
      }
      // TODO: end deletion
    };
  };
...
exports.makeParser = function (specs) {
  ...
  Object.keys(specs).forEach(function (key) {
    retVal.whenFieldIs(RAW_TYPE, key).applyConversion(specs[key]);
  });
