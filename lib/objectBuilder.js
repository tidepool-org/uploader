...
module.exports = function () {
  ...
  function setOffsetLookup(lookup) {
    tzOffsetLookup = lookup;
  }
    ...
    return {
      ...
      // and returns a copy of the object with all functions removed.
        ...
        if (self.dateObj != null) {
          var utc = tzOffsetLookup(self.dateObj, self.index || null);
          self.time = utc.time;
          self.timezoneOffset = utc.timezoneOffset;
          delete self.dateObj;
        }
  ...
  return {
    ...
    setOffsetLookup: setOffsetLookup
  };
};
