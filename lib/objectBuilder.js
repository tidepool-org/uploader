...
module.exports = function () {
  ...
  function makePumpSettingsAllObjects() {
    var rec = _.assign(_createObject(), deviceInfo, {
      type: 'pumpSettings',
      activeSchedule: REQUIRED,
      units: REQUIRED,
  ...
  function makeWizard() {
    var rec = _.assign(_createObject(), deviceInfo, {
      ...
      bgInput: OPTIONAL,
      carbInput: OPTIONAL,
      insulinOnBoard: REQUIRED,
      insulinCarbRatio: REQUIRED,
      insulinSensitivity: REQUIRED,
      bgTarget: REQUIRED,
      bolus: REQUIRED,
      units: REQUIRED,
      payload: OPTIONAL
  ...
  return {
    ...
    makePumpSettingsAllObjects: makePumpSettingsAllObjects,
