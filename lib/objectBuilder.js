...
module.exports = function () {
  ...
  function makeDeviceEventPumpSettingsOverride() {
    var rec = _.assign(_createObject(), deviceInfo, {
      ...
      overridePreset: OPTIONAL,
      duration: REQUIRED,
      method: OPTIONAL,
      expectedDuration: OPTIONAL,
      bgTarget: OPTIONAL,
      units: OPTIONAL,
      basalRateScaleFactor: OPTIONAL,
      carbRatioScaleFactor: OPTIONAL,
      insulinSensitivityScaleFactor: OPTIONAL,
      payload: OPTIONAL
    });
    rec._bindProps();
    return rec;
  ...
  function makeTandemPumpSettings() {
    var rec = _.assign(_createObject(), deviceInfo, {
      ...
      bgTargets: {},
      sleepSchedules: OPTIONAL,
      insulin: OPTIONAL,
      bolus: OPTIONAL, // this can be removed after Jellyfish is deprecated
      boluses: {},
      manufacturers: OPTIONAL,
      model: OPTIONAL,
      serialNumber: OPTIONAL,
