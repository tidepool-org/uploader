...
if (!(process.env.NODE_ENV === 'test')) {
  ...
  // var TUSB3410 = require('tusb3410');  see https://bugs.chromium.org/p/chromium/issues/detail?id=1189418
}
      ...
      if (deviceInfo.port) {
        ...
        switch(deviceInfo.userSpaceDriver) {
          ...
          case 'cp2102':
            ...
            break;
          case 'tusb3410':
            /* see https://bugs.chromium.org/p/chromium/issues/detail?id=1189418
