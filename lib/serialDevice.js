...
module.exports = function(config) {
  ...
  function connect(deviceInfo, packethandler, probe, cb) {
    ...
    chrome.serial.getDevices(function(ports) {
      ...
      async.eachSeries(ports, function(port, done) {
        ...
        chrome.serial.connect(port.path, { bitrate: bitrate, name: port.path, sendTimeout: 100, receiveTimeout: 200 }, function(conn) {
