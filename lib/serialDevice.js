...
module.exports = function(config) {
  ...
  function do_probe(probe,done,conn) {
    probe(function(err) {
      if (!err) {
          ...
          if (conn && conn.connectionId) {
            ...
            if(connectopts.ctsFlowControl) {
              chrome.serial.setControlSignals(conn.connectionId,{dtr:false,rts:true}, function(){
                ...
                chrome.serial.getControlSignals(conn.connectionId, function(cs) {
                  console.log("Connection options:", conn);
                  console.log("Control signals:", cs);
