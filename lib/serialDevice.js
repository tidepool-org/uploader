    ...
    chrome.serial.getDevices(function(ports) {
      ...
      async.eachSeries(ports, function(port, done) {
        ...
        if (result) {
          ...
          if((this.app.state._os === 'mac') && (deviceInfo.driverId === 'DexcomG4') && (deviceInfo.path.match(deviceInfo.portPattern) === null)) {
            return cb(new Error('You may also need to restart your Dexcom receiver: ' + deviceDebugInfo));
          }
