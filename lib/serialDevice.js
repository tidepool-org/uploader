...
module.exports = function(config) {
  ...
  function connect(packethandler, connectedCB) {
    ...
    chrome.serial.getDevices(function(ports) {
      ...
      // console.log(ports);
      console.log('Module #' + moduleNumber + ' searching for ' + portpattern);
  ...
  function changeBitRate(newrate, cb) {
    if (connection) {
      ...
      chrome.serial.disconnect(connection.connectionId, function(result) {
        ...
        console.log('reconnecting on ' + port.path + ' at ' + bitrate);
        setTimeout(function() {
  ...
  function writeSerial(bytes, callback) {
    ...
    if (bytes == null) {
      console.log('just tried to send nothing!');
    } else {
  ...
  function setPattern(p) {
    console.log('Module #' + moduleNumber + ' setting portpattern to ' + p);
    portpattern = p;
  }
