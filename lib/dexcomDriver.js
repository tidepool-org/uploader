...
module.exports = function(config) {
    ...
    var BASE_DATE_DEVICE = cfg.timeutils.buildMsec(
      { year: 2009, month: 1, day: 1, hours: 0, minutes: 0, seconds: 0 }, null
    );
    var BASE_DATE_UTC = cfg.timeutils.buildMsec(
      { year: 2009, month: 1, day: 1, hours: 0, minutes: 0, seconds: 0 }, cfg.tz_offset_minutes
    );
