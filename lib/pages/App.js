      ...
      return (
        <div>
          <ClinicUserEdit
            ...
            cancelEdit={this.handleClickChangePerson}
            errorMessage={this.props.createCustodialAccountErrorMessage}
            errorDismissed={this.props.createCustodialAccountErrorDismissed}
  ...
  renderChangePersonLink() {
    return (
      <div className={styles.changePerson}
        onClick={this.props.uploadIsInProgress ? this.noopHandler : this.handleClickChangePerson}>Change Person</div>
    );
  }
