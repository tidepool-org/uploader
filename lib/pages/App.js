...
export default class App extends Component {
  ...
  renderPage() {
    ...
    if (page === pages.LOADING) {
      ...
      let clinicUserBlock = this.renderClinicUserBlock();
      ...
      return (
        <div>
          <ClinicUserEdit
            ...
            errorMessage={this.props.createCustodialAccountErrorMessage} />
        </div>
      );
    } else {
    ...
    return (
      <div className={styles.footerRow}>
        ...
        <div className="mailto">
          <a className={styles.footerLink} href="mailto:support@tidepool.org?Subject=Feedback on Uploader" target="mailto">Send us feedback</a>
        </div>
      </div>
    );
  }
