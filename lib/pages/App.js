...
import * as metrics from '../redux/constants/metrics';
      ...
      return (
        <div className={styles.mainWrap}>
          ...
          <UploadList
            ...
            isClinicAccount={this.props.isClinicAccount}
            onChooseDevices={this.handleClickChooseDevices.bind(this, {metric: {eventName: metrics.CLINIC_CHANGE_DEVICES}})}
      ...
      return (
        <div>
          <ClinicUserEdit
            ...
            cancelEdit={this.handleClickChangePerson.bind(this, {metric: {eventName: metrics.CLINIC_ADD_CANCEL}})}
  ...
  renderChangePersonLink() {
    ...
    return (
      <div className={classes}
        onClick={this.props.uploadIsInProgress ? this.noopHandler : this.handleClickChangePerson.bind(this, {metric: {eventName: metrics.CLINIC_CHANGE_PERSON}})}>Change Person</div>
    );
  }
