...
var bows = isBrowser ? require('../bows')('Api') : console.log;
...
api.init = function(options, cb) {
  var tidepoolLog = isBrowser ? bows('Tidepool') : console.log;
...
function postBlockToPlatform(data, groupId, callback) {
  ...
  if(!_.isEmpty(groupId)){
    api.log('postBlockToPlatform: for other user');
    ...
    api.log('postBlockToPlatform: as logged in user');
