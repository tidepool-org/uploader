...
device.driverManifests = {
  ...
  CareSens: {
    ...
    usb: [
      ...
      { vendrId: 3835, productId: 17 }, // ReliOn Prime
    ],
  },
  ReliOn: {
    mode: 'serial',
    usb: [
      { vendorId: 1659, productId: 8963, driver: 'pl2303' }, // Glucocard Expression
      { vendorId: 1027, productId: 24597, driver: 'ftdi' }, // FT230x
      { vendorId: 1027, productId: 24577, driver: 'ftdi' }, // FT232R
      { vendorId: 6753, productId: 13328, driver: 'tusb3410' }, // Abbott cable TODO: remove this!
    ],
  },
};
