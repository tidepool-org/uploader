...
let insuletOmniPod;
try {
  if (process.env.PLATFORM_SWITCH === 'true') { // TODO: this should look at switch endpoint
    ...
    insuletOmniPod = require('../drivers/insulet/insuletDriver');
  } else {
    device.log('Using Jellyfish versions of Tandem and Omnipod drivers');
    tandemDriver = require('../drivers/tandem/jellyfish/tandemDriver');
    insuletOmniPod = require('../drivers/insulet/jellyfish/insuletDriver');
  }
} catch (e) {
