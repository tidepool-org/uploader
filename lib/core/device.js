...
device.init = function(options, cb) {
  ...
  chrome.runtime.getPlatformInfo(function (platformInfo) {
    ...
    // TODO Not sure about this: apparently this service needs to "warm up"
    // before any device detection can happen, so artificially give it
    // a second. Will need to be revisited...
    setTimeout(cb, 1000);
  });
};
