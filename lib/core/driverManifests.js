import { getProductionSpecEntry } from "../drivers/roche/utils";
...
const driverManifests = {
  ...
  InsuletOmniPod: {
    ...
    usb: [
      ...
      { vendorId: 3725, productId: 8200 }, // OP5, nut supported
    ],
  },
  Dexcom: {
    mode: 'serial',
  ...
  EmbracePRO: {
    mode: 'HID',
    usb: [
      { vendorId: 1240, productId: 63 }, // Allmedicus cable (LinkDr)
    ],
  },
  GlucoZenAuto: {
    mode: 'HID',
