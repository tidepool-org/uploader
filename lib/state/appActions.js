...
appActions.changeGroup = function(userid) {
  ...
  //we are store the tz on a per device basis
  var devicesById = localStore.getItem('devices') || {};
  var targetDevices = devicesById[userid] || [];
  //timezones
  var timezoneById = localStore.getItem('timezones') || {};
  var targetTimezone = timezoneById[userid] || '';
...
appActions.changeTimezone = function(timezone) {
  console.log('tz currently: ',this.app.state.targetTimezone);
  console.log('tz now: ',timezone);
  this.app.setState({targetTimezone: timezone});
};
...
appActions.storeUserTargets = function(targetId) {
  ...
  //timezones
  var timezonesById = localStore.getItem('timezones') || {};
  timezonesById[targetId] = this.app.state.targetTimezone;
  localStore.setItem('timezones', timezonesById);
