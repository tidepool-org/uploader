...
appState.getInitial = function() {
  ...
  var uploads = [
    ...
    },
    {
      ...
      win: {driverLink:'http://tidepool.org/downloads/', driverLabel: 'Windows' },
      mac: {driverLink:'https://www.silabs.com/Support%20Documents/Software/Mac_OSX_VCP_Driver.zip', driverLabel: 'Mac'}
    },
    // {
