...
appState.getInitial = function() {
  ...
  var uploads = [
    {name: 'Insulet OmniPod', key: 'omnipod', source: {type: 'block', driverId: 'InsuletOmniPod', extension: '.ibf'}},
    {name: 'Dexcom G4 Platinum', key: 'dexcom', source: {type: 'device', driverId: 'DexcomG4'}},
    // {name: 'OneTouch Mini', key: 'onetouchmini', source: {type: 'device', driverId: 'OneTouchMini'}},
    {name: 'Abbott FreeStyle Precision Xtra', key: 'precisionxtra', source: {type: 'device', driverId: 'AbbottFreeStyle'}}
  ];
