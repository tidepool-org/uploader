 ...
 module.exports = {
    ...
    userlist: {
        ...
        aa_Messages: {
           ...
           Pump_body_not_accepted_alarm: { value: 13, name: 'Pump body not accepted alarm'},
           Version_mismatch_alarm: { value: 14, name: 'Version mismatch alarm'},
           Key_alert: { value: 15, name: 'Key alert'},
           Very_low_power_replace_pump_body_soon: { value: 16, name: 'Very low power, replace pump body soon'},
           Very_low_cartridge: { value: 17, name: 'Very low cartridge'},
           Temp_basal_alert: { value: 18, name: 'Temp basal alert'},
           Low_cartridge: { value: 19, name: 'Low cartridge'},
           Dead_pump_body_battery: { value: 20, name: 'Dead pump body: battery'},
           Reminder_Check_bg: { value: 21, name: 'Reminder: Check bg'},
           Bolus_reminder: { value: 22, name: 'Bolus reminder'},
           ...
           Delivery_canceled: { value: 31, name: 'Delivery canceled'},
           Bolus_reminder_canceled: { value: 32, name: 'Bolus reminder canceled'},
           Cartridge_may_be_expired: { value: 33, name: 'Cartridge may be expired'},
        ...
        ac_ClearCondition: {
           ...
           ac_PumpDetached: { value: 5, name: 'PumpDetached'},
           ac_UIStartPump: { value: 6, name: 'UIStartPump'},
           ac_NoPower: { value: 7, name: 'NoPower'},
           ac_RemoveLowCart: { value: 8, name: 'RemoveLowCart'},
           ac_CartridgeEmpty: { value: 9, name: 'CartridgeEmpty'},
           ac_ExitedPrime: { value: 10, name: 'ExitedPrime'},
           ac_SetTimeDate: { value: 11, name: 'SetTimeDate'},
           ac_CartridgeDateOK: { value: 12, name: 'CartridgeDateOK'},
           ac_SufficientPower: { value: 13, name: 'SufficientPower'},
           ac_TempBasalEnded: { value: 14, name: 'TempBasalEnded'},
           ac_PbReminderReset: { value: 15, name: 'PbReminderReset'},
           ac_MAX_LEVEL: { value: 16, name: 'MAX_LEVEL'}
        },
    ...
    recordTypes: {
        ...
        USER_SETTINGS: {
            ...
            max: 1,
            type: 'settings',
            struct: 's2hs32h2s7h8z22h8z22h8z22h8z23hs12h2s4hs32z32z32z',
            fields: [
                'crc',
                'SmartBolusEnable',
