...
export default class App extends Component {
  ...
  render() {
    ...
    return (
      <div className={styles['App']} onClick={this.handleDismissDropdown}>
        <div className={styles['App-header']}>{this.renderHeader()}</div>
        <div className={styles['App-page--'+page.toLowerCase()]}>{this.renderPage()}</div>
        <div className={styles['App-footer']}>{this.renderFooter()}</div>
  ...
  renderHeader() {
    ...
    if (!isLoggedIn) {
      return (
        <div className={styles['App-signup']}>
  ...
  renderFooter() {
    ...
    return (
      <div>
        ...
        <div className={styles['App-footer-version']}>{`v${version} beta`}</div>
      </div>
    );
  }
