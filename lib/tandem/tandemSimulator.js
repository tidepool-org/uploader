        ...
        if (currBasal.time !== event.time) {
          ...
          if(currBasal.deliveryType === 'temp') {
            if (currTempBasal != null) {
              ...
              if(currTempBasal.duration && currTempBasal.time_left && currTempBasal.time_left !== 0) {
                event.duration = currTempBasal.duration - currTempBasal.time_left - currBasal.duration;
                annotate.annotateEvent(currBasal, 'tandem/basal/fabricated-from-time-left');
              } else {
