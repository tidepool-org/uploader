...
function computeMillisInCurrentDay(e){
  var dateTime = sundial.applyOffset(e.time, e.timezoneOffset);
  return sundial.getMsFromMidnight(dateTime);
};
          ...
          case 'scheduled':
            ...
            if (currSettings == null) {
              ...
              if (currSchedule == null) {
                ...
                // TODO: change and/or move to sundial!
                var newTs = new Date(Date.parse(parts[doneIndex].time) - millisInDay + currRate.start).toISOString();
