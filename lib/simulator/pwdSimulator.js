...
exports.make = function(config){
    ...
    function processParts(parts){
      ...
      if (doneTime < timeMillis) {
          ...
          case 'scheduled':
            ...
            if (currSettings == null) {
              ...
              if (currSchedule == null || currSchedule.length === 0) {
                ...
                if (!_.isEmpty(currSettings.deviceId)) {
                  basalBuilder.set('deviceId', currSettings.deviceId);
                }
        ...
        for (i = parts.length - 2; i >= 0; --i) {
          if (parts[i].deliveryType === 'temp' && !_.isEmpty(parts[i].percent) && !_.isEmpty(parts[i+1].rate)) {
  ...
  return {
    ...
    suspend: function(){
      ...
      //TODO: test this!!
      console.log('## was ## ',JSON.stringify(event));

        /*if (!_.isEmpty(currSettings.deviceId)) {
          console.log('## was ## ',JSON.stringify(event))
          event.deviceId =  currSettings.deviceId;
          console.log('## now ## ',JSON.stringify(event))
        }*/
      ...
      //currBasal
      console.log('## now 1 ## ',JSON.stringify(currBasal));

      var suspendBasal = suspendBasalBuilder.done();
      console.log('## now ## ',JSON.stringify(suspendBasal));
