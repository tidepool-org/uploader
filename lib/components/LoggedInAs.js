...
var LoggedInAs = React.createClass({
  ...
  render: function() {
    ...
    return (
      <div className={styles['LoggedInAsWrapper']}>
        <div className={styles['LoggedInAs']} onClick={this.props.onClicked}>
          <span>{_.get(user, 'fullName', '')}</span>
          <i className={styles['Menu-arrow-down icon-arrow-down']}></i>
        </div>
        {dropMenu}
      </div>
    );
  ...
  renderDropMenu: function() {
    ...
    return (
      <div className={styles['Menu-dropdown']} onClick={stopPropagation}>
        <ul>
  ...
  renderChooseDevices: function() {
    ...
    return (
      <a className={styles['LoggedInAs-link']}
  ...
  renderLogout: function() {
    if (this.state.loggingOut) {
      return <span className={styles['LoggedInAs-link']}>Logging out...</span>;
    }
    ...
    return (
      <a className={styles['LoggedInAs-link']}
        ...
        <i className={styles['icon-logout']}></i>
        Logout
      </a>
    );
  },
