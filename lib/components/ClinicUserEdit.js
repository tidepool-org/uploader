...
var ClinicUserEdit = React.createClass({
  ...
  isDisabled: function() {
    var dateString = _.get(this,'refs.year.value')+'-'+_.get(this,'refs.month.value')+'-'+this.zeroPad(_.get(this,'refs.day.value', ''));
    return (!_.get(this, 'refs.name.value')) || (!_.get(this,'refs.month.value')) ||
      (!_.get(this,'refs.day.value')) || (!_.get(this,'refs.year.value')) ||
      (!sundial.isValidDateForMask(dateString, 'YYYY-MM-DD')) ||
    ...
    return (
      <div className={styles.main}>
        ...
        <form className={styles.form}>
          ...
          <div className={styles.inputWrap}>
            <label className={styles.inputLabel} htmlFor="mrn">MRN</label>
