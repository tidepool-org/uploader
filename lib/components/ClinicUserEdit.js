...
var ClinicUserEdit = React.createClass({
  ...
  handleChange: function(e){
    ...
    if (_.get(this, 'refs.name.value') && _.get(this, 'refs.month.value') &&
        _.get(this, 'refs.day.value') && _.get(this, 'refs.year.value')) {
          formsFilled = true;
    }
    this.setState({[e.target.name]: e.target.value, formsFilled: formsFilled});
  },

  handleBlur: function(e){
    if(this.state.formsFilled){
      this.validateForm();
    }
  },
  ...
  renderButton: function() {
    ...
    return (
      <button type="submit"
        ...
        disabled={(!!this.state.errorMessage || !this.state.formsFilled)}>
        {text}
      </button>
    );
  },
      ...
      <div className={styles.main}>
        ...
        <form className={styles.form}>
          <div className={styles.inputWrap}>
            ...
            <input className={styles.input} ref="name" name='name' value={this.state.name} onChange={this.handleChange} onBlur={this.handleBlur} placeholder=""/>
          </div>
          <div className={styles.inputWrap}>
