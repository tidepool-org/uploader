...
var ClinicUserEdit = React.createClass({
  propTypes: {
    createErrorMessage: React.PropTypes.string,
    createErrorDismissed: React.PropTypes.bool.isRequired,
  ...
  renderCreateError: function() {
    if (this.props.createErrorDismissed || !this.props.createErrorMessage) {
      return null;
    }
    return (
      <div className={styles.error}>
        <span>
          {this.props.createErrorMessage}<i className={styles.iconClose} onClick={this.props.dismissCreateCustodialAccountError}></i>
        </span>
      </div>
    );
  },
