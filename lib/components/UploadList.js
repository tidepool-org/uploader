  ...
  renderErrorForUpload(upload) {
    ...
    const errorMessage = upload.error.driverLink ?
      (
        <div className={styles.errorMessageWrapper}>
          ...
          <span className={styles.errorMessageLink}><a href={upload.error.driverLink} target="_blank">Tidepool USB driver</a></span>
        </div>
      ) :
      (
        <div className={styles.errorMessageWrapper}>
    ...
    return (
      <div className={styles.errorItem}>
        {errorMessage}
        <div className={styles.errotText}><a href="" onClick={makeToggleDetailsFn()}>{showErrorsText}</a></div>
        {errorDetails}
      </div>
    );
  }
