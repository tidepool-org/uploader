    ...
    const errorMessage = upload.error.driverLink ?
      (
        <div className="UploadList-error-message-wrapper">
          ...
          <span className="UploadList-error-message-friendly">{'It\'s possible you need to install the '}</span>
          <span className="UploadList-error-message-link"><a href={upload.error.driverLink} target="_blank">Tidepool USB driver</a></span>
        </div>
      ) :
      (
        <div className="UploadList-error-message-wrapper">
          <span className="UploadList-error-message">{this.props.text.UPLOAD_FAILED}</span>
          <span className="UploadList-error-message-friendly">{upload.error.message}</span>
        </div>
      );
