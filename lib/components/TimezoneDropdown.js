  ...
  render: function() {
    return (
      <div className={styles['TimezoneDropdown']}>
        <div className={styles['TimezoneDropdown-timezone']}>
          <div className={styles['TimezoneDropdown-timezone--label']}>{this.props.selectorLabel}</div>
          <div className={styles['TimezoneDropdown-timezone--list']}>
