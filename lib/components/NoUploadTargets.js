    ...
    return (
      <div>
        <div className={styles.main}>
          ...
          <p className={styles.paragraph}>Or, ask the person you are uploading for to grant you access to upload.<br/> <a href={urls.HOW_TO_SHARE_DATA_KB_ARTICLE} target="_blank">How?</a></p>
        </div>
      </div>
    );
  }
