      ...
      <div className={styles['Login']}>
        <form className={styles['Login-form']}>
          <div className={styles['Login-input']}>
            <input className={styles['form-control']} ref="username" placeholder="Email"/>
          </div>
          <div className={styles['Login-input']}>
            <input className={styles['form-control']} ref="password" placeholder="Password" type="password"/>
          </div>
          <div className={styles['Login-actions']}>
            <div className={styles['Login-actionsLeft']}>
              <div className={styles['Login-remember']}>
                <input type="checkbox" ref="remember" id="remember"/>
                <label htmlFor="remember">Remember me</label>
              </div>
              <div className={styles['Login-forgot']}>{this.renderForgotPasswordLink()}</div>
            </div>
            <div className={styles['Login-actionsRight']}>
              {this.renderButton()}
            </div>
          </div>
          <div className={styles['Login-error']}>{this.renderError()}</div>
        </form>
      </div>
    );
  },
