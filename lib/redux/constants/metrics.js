...
export const CLICK_SEE_IN_BLIP = 'Clicked See Data in Blip';
...
export const CARELINK_UPLOAD_SUCCESS = 'CareLink Upload Successful';
export const CARELINK_UPLOAD_FAILURE = 'CareLink Upload Failed';
