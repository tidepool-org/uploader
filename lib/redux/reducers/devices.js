const devices = {
  ...
  medtronic: {
    instructions: 'Connect your Bayer Contour NextLink to your computer',
    image: {
    ...
    selectName: 'Medtronic direct from Bayer Contour NextLink',
    showDriverLink: {mac: false, win: false},
  ...
  medtronic: {
    instructions: 'Plug Bayer meter into USB port',
    key: 'medtronic',
    name: 'Medtronic',
    showDriverLink: {mac: false, win: false},
    source: {type: 'device', driverId: 'Medtronic'},
