...
export function getCreateCustodialAccountErrorMessage(status){
  switch(status) {
    ...
    case 409:
      return 'We can\'t create this account becuase that email address already has an account.';
    case 500:
      return 'Er sorry, we cant create this account right now. Try again in a few minutes. ';
    default:
      return 'Uh oh, we cant create this account. Try again in a few minutes and check your internet connection. ';
  }
}
