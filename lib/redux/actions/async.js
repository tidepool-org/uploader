...
export function doDeviceUpload(driverId, utc) {
  return function (dispatch, getState) {
    ...
    const opts = {
      ...
      progress: syncActions.uploadProgress,
      version: version
    };
    ...
    function getStep(uploads) {
      return _.get(uploads, ['uploadInProgress', 'progress', 'step'], null);
    }
