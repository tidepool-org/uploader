...
function getDeviceTargetsByUser(targetsByUser) {
...
export function putTargetsInStorage() {
  return (dispatch, getState) => {
    ...
    const uploadsByUser = getDeviceTargetsByUser(usersWithTargets);
...
export function retrieveTargetsFromStorage() {
  return (dispatch, getState) => {
    ...
    if (targets === null) {
      ...
      const uploadsByUser = getDeviceTargetsByUser(targets);
