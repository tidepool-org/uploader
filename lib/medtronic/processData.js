...
var RECORD_TYPES = {
  ...
  UNKNOWN_6E: { value:0x6E, head_length:1, date_length:2, body_length:48, name:'UNKNOWN_6E'}, //TODO: make sure about date_length
...
var processPages = function(data, callback) {
  ...
  for(var i = 0; i < pages.length; i++) {
    ...
    while(index < 1024) {
      ...
      if(!record.jsDate) {
        console.log("WRONG DATE:", common.bytes2hex(record.date));
      }
      console.log(common.bytes2hex(record.head),',',common.bytes2hex(record.date),',',common.bytes2hex(record.body));
