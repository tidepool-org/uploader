...
function buildSettings(records) {
  ...
  var getWizardSettings = function(record) {
    ...
    oldSettings.units = {
      bg : record.body[0] & 0x04 ? 'mg/dL' : 'mmol/L',
      carb : record.body[0] & 0x01 ? 'grams' : 'exchanges'
    };
    ...
    newSettings.units = {
      bg : record.body[index] & 0x04 ? 'mg/dL' : 'mmol/L',
      carb : record.body[index] & 0x01 ? 'grams' : 'exchanges'
    };
