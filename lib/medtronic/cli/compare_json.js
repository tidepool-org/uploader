...
var EXCLUDES = ['index','source','previous','payload','deviceId','scheduleName', 'annotations'];
/* reasons for exclusion:
   ...
   TODO: check when available: scheduleName - availability of pump settings depends on when first uploaded
...
function cleanup(record) {
  if(record.suppressed) {
    record.suppressed = _.pick(record.suppressed, ['type', 'deliveryType', 'rate', 'percent']); // TODO: scheduleName, suppressed if available
  }
  if (record.bolus) {
