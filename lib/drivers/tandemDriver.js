...
module.exports = function (config) {
  ...
  var multiLogRequester = function (start, end, progress, callback) {
    ...
    var retryTimeout = function() {
      ...
      tandemCommand(COMMANDS.LOG_ENTRY_SEQ_MULTI_REQ, [receiveSeq,end-receiveSeq], function (err) {
        if(err) {
          callback(err,null);
        }
      });
    ...
    tandemCommand(COMMANDS.LOG_ENTRY_SEQ_MULTI_REQ, [sendSeq,end-sendSeq], function (err) {
      if(err) {
        callback(err,null);
      }
      else {
