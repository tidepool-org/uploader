...
module.exports = function (config) {
  ...
  var buildSuspendResumeRecords = function (data, records) {
    var suspendResumeRecords = filterLogEntries([PUMP_LOG_RECORDS.LID_PUMPING_SUSPENDED,PUMP_LOG_RECORDS.LID_PUMPING_RESUMED], data.log_records);

    suspendResumeRecords.forEach(function (entry) {
      var postrecord;

      if (entry.header_id === PUMP_LOG_RECORDS.LID_PUMPING_SUSPENDED.value) {
    ...
    uploadData: function (progress, data, cb) {
      ...
      */
      ...
      if (!_.isEmpty(data.log_records)) {
        ...
        postrecords = buildSuspendResumeRecords(data, postrecords);
