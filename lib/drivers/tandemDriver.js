...
module.exports = function (config) {
  ...
  var buildCartridgeChangeRecords = function (data, records) {
    var cartridgeRecords = filterLogEntries([PUMP_LOG_RECORDS.LID_TUBING_FILLED,PUMP_LOG_RECORDS.LID_CANNULA_FILLED], data.log_records);
    //TODO: PUMP_LOG_RECORDS.LID_CARTRIDGE_FILLED?
