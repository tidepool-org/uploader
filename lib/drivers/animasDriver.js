  ...
  var handshake = function(iter) {
    return {
      packet: buildPacket(
        ...
        ADDRESS_CONNECT, CMDS.HANDSHAKE.value, 10, [0x01,0x00,0x00,0x00,0xFF,0xFF,0xFF,0xFF,0x00,0x00]
      ),
      parser: function (packet) {
...
/*
    for (var i = 0; i < 256; i++)
    {
      var forcedDisconnect = buildPacket(i, 0x53, 0, null);
      serialDevice.writeSerial(forcedDisconnect, function () {});
    }
*/
