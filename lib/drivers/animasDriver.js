...
module.exports = function (config) {
  ...
  return {
    ...
    getConfigInfo: function (progress, data, cb) {
      ...
      readBasalPrograms(function (err, programs) {
        if(err) {
          return cb(err,null);
        }
        else{
          data.settings = {};
          data.settings.basalPrograms = programs;

          readActiveBasalProgram(function (err, activeProgram) {
            if(err) {
              return cb(err,null);
            }
            else{
              data.settings.activeProgram = activeProgram;
