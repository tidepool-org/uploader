    ...
    for(var b in data.wizardRecords) {
      ...
      if (bolusdatum.syncCounter !==  wizarddatum.sync_counter) {
        ...
        if(wizarddatum.configuration.units === 'mmol/L') {
          ...
          wizarddatum.bg_delta = Math.round(wizarddatum.bg_delta * 1.8);
          wizarddatum.target_bg = Math.round(wizarddatum.target_bg * 1.8);
          wizarddatum.isf = Math.round(wizarddatum.isf * 1.8);
        }
