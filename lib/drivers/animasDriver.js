...
var debug = console.log; // TODO: require('../bows')('AnimasDriver');
var verbose = true; // TODO: (typeof __DEBUG__ === 'undefined') ? false : __DEBUG__;
...
module.exports = function (config) {
  ...
  return {
    ...
    connect: function (progress, data, cb) {
      debug('STEP: connect');
      cfg.deviceComms.connect(data.deviceInfo, animasPacketHandler, function(err) {
        if (err) {
          return cb(err,null);
        }
