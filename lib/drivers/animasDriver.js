...
module.exports = function (config) {
  ...
  return {
    ...
    processData: function (progress, data, cb) {
      ...
      for(var s in data.suspendResumeRecords) {
        ...
        if(suspendresumedatum.resumeJsDate > suspendresumedatum.suspendJsDate) {
          var suspendResume = cfg.builder.makeDeviceEventSuspendResume()
            ...
            .with_duration(suspendresumedatum.resumeJsDate - suspendresumedatum.suspendJsDate)
            .with_payload({
      ...
      console.log('getDataServicesEvents:',simulator.getDataServicesEvents());
    ...
    uploadData: function (progress, data, cb) {
      ...
      data.post_uploads = simulator.getEvents();
      data.post_dataservices = simulator.getDataServicesEvents();
