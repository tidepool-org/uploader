...
module.exports = function (config) {
  ...
  var setupConnection = function(destinationAddress) {
    ...
    primaryAddress = [(Math.floor(Math.random() * 100) + 1),0x00,0x00,0x00]; // use random primary address
    connectionAddress = (Math.floor(Math.random() * 100) + 1) | 0x01; // use random primary address with LSB as 1
