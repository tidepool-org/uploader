  ...
  return {
    ...
    fetchData: function (progress, data, cb) {
      ...
      const getterFunctions = [
        ...
        cb => { protocol.getCfgData(1, cb); },
        cb => { protocol.getCfgData(2, cb); },
        cb => { protocol.getCfgData(3, cb); },
        cb => { protocol.getCfgData(4, cb); },
        cb => { protocol.getCfgData(5, cb); },
        cb => { protocol.getCfgData(6, cb); },
        cb => { protocol.getCfgData(7, cb); },
        // cfg table 8 is not described in the specs...
        cb => { protocol.getCfgData(9, cb); },
        cb => { protocol.getCfgData(10, cb); },
        cb => { protocol.getDatabase(0, cb); },
        cb => { protocol.getDatabase(6, cb); },
        cb => { protocol.getDatabase(7, cb); },
    ...
    processData: function (progress, data, cb) {
      ...
      // TODO: evaluate data
      //protocol.evaluateAapPackets(data.aapPackets);
    },
