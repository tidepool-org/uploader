      ...
      async.series({
        ...
        current_cbg_page : function(callback){
          getOneRecord(readCurrentCBGPage(), false, true, function(err, result) {
            ...
            var currentPage = positionToPage(lastCBGPosition, result.currentCBGPosition, 'CGM history');
            var glucosePage = result.currentGlucosePosition;
            var isigPage = result.currentIsigPosition;
