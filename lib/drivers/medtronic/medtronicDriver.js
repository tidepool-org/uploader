    ...
    return {
      ...
      parser: function (packet) {
        ...
        return {
          ...
          combinationBolusEnabled: medtronicMessage[4] ? true : false,
  ...
  return {
      ...
      async.series({
        ...
        current_cbg_page : function(callback){
          getOneRecord(readCurrentCBGPage(), false, true, function(err, result) {
            ...
            var glucosePage = positionToPage(lastGlucosePosition, result.currentGlucosePosition, 'glucose') + 1;
            var isigPage = positionToPage(lastIsigPosition, result.currentIsigPosition, 'isig') + 1;
      ...
      function(err, results){
          ...
          if(!err){
              ...
              settings.bolus = {
                ...
                combination: {
                  enabled: results.settings.combinationBolusEnabled
                }
              };
              settings.basal = {
                rateMaximum : {
    ...
    uploadData: function (progress, data, cb) {
      ...
      var sessionInfo = {
        ...
        deviceManufacturers: data.settings.deviceManufacturers,
