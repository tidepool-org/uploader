  ...
  var readCurrentPage = function () {
    ...
    return {
      ...
      parser: function (packet) {
        ...
        var currentPage = Math.min(struct.extractBEInt(medtronicMessage,0), MAX_HISTORY_PAGES) + 1;
    ...
    getConfigInfo: function (progress, data, cb) {
      ...
      function(err, results){
          ...
          if(!err){
              ...
              common.checkDeviceTime(settings.currentDeviceTime, cfg.timezone, function(err) {
                return cb(err, data);
              });
          } else {
