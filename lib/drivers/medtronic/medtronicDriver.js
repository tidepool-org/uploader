    ...
    return {
      ...
      parser: function (packet) {
        ...
        if (lastPosition != null) {
          debug('Last pump history page was', lastPosition, ', now at', currentPosition);
          currentPage = currentPosition - lastPosition;
        } else {
  ...
  return {
    ...
    setup: function (deviceInfo, progress, cb) {
      ...
      if(isBrowser) {
        ...
        debug('Last pump history page read was', localStorage.getItem('lastPosition'));
