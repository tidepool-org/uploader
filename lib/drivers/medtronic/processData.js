...
function buildSettings(records) {
  ...
  //   if(change.jsDate.getFullYear() <= 2012) {
  //     debug('Dropping basal profile change in 2012 or earlier: ', change.jsDate, change.type.name);
  //     return false;
  //   }
  //   return true;
  // });
  ...
  for(var i=0; i < changes.length; i++) {
    ...
    if(record.type.value === RECORD_TYPES.BOLUS_WIZARD_CHANGE.value ) {
      ...
      console.log('JSDATE', record.jsDate);
      console.log("Settings change:", JSON.stringify(settingsChange, null, 4));
      console.log("wizardSettings:", wizardSettings);
