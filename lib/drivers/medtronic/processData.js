...
function buildSettings(records) {
  ...
  var getWizardSettings = function(record) {
    ...
    console.log("BODY[1] and [2]:", record.body[1], record.body[2]);
    ...
    console.log("bg targets:", struct.extractBytes(record.body, index - 1, SIZES.BG_TARGET));
    console.log("last:", record.body[index+SIZES.BG_TARGET]);
    debugger;
