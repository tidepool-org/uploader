...
module.exports = function (config) {
  ...
  var buildSettingsRecords = function buildSettingsRecord(data, postrecords) {
    ...
    var postsettings = cfg.builder.makePumpSettings()
      ...
      .with_deviceTime(data.log_records[data.log_records.length - 1].deviceTime) //TODO: change to settings time
      .with_timezoneOffset(data.log_records[data.log_records.length - 1].timezoneOffset) //TODO: change to settings timezone offset
