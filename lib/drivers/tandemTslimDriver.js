...
/*
  ...
  */              var recordType = getLogRecordById(rec.header_id);
    ...
    var buildBasalRecords = function (data, records) {
        ...
        var finalizeBasal = function(event, basal) {
            console.log('basal:', basal);
            var duration = event.header_ts - basal.time.getTime();
        ...
        basalRecords.forEach( function(event, index) {
            if (event.header_id == PUMP_LOG_RECORDS.LID_TEMP_RATE_ACTIVATED.value) {
                ...
                console.log('event.change_type =',event.change_type);
                switch(event.change_type) {
                    ...
                    case 'new_profile':
                        ...
                        if (currentTemp != undefined) {
                            ...
                            currentTemp = makeTempBasal(event, currentScheduled);
                            currentBasal = currentTemp;
                        } else {
