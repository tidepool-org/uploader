  ...
  var tandemFetch = function (progress, data, callback) {
    ...
    function getNewestEvent(err, result) {
      ...
      if (err) {
        ...
        console.log('newest record: ', result.payload.timestamp);
        maxIndex = end_seq;
    ...
    function getOldestEvent(err, result) {
      ...
      if (err) {
        ...
        console.log('oldest record: ', result.payload.timestamp);
        minIndex = start_seq;
        currentIndex = (minIndex + maxIndex) / 2 | 0;
        tandemLogRequester(end_seq, end_seq, binarySearch);
    ...
    function binarySearch(err, result) {
      ...
      if (err) {
        ...
        if (minIndex <= maxIndex) {
          console.log('record time: ', result.payload.timestamp);
          ...
          console.log('90 day, closest record: ', result.payload.timestamp);
