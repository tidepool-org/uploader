                ...
                if (result.valid && seq < end_seq) {
                    if (result.descriptor === 125) {
                        ...
                        if (recordType != null) {
                            ...
                            _.assign(record, struct.unpack(result.payload['tdeps'], 0, recordType.format, recordType.fields ));
                            retval.push(record);
                            console.log(record);
