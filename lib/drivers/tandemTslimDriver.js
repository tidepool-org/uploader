...
module.exports = function (config) {
  ...
  var buildSettingsRecords = function buildSettingsRecord(data, postrecords) {
    ...
    var last;
    records = _.sortBy(records, function(d) { return d.index; }).reverse();
    records = _.sortBy(records, function(d) { return d.segment_index});
    records = _.sortBy(records, function(d) { return d.idp; });
    records.forEach(function (record) {
      console.log('record index: ', record.index, ', idp: ', record.idp, ', segment index: ',record.segment_index);
