...
module.exports = function (config) {
  ...
  var PUMP_LOG_RECORDS = {
    LID_BASAL_RATE_CHANGE: {
      ...
      postprocess: function (rec) {
        // if true, segment advanced based on time
        // that is, the user changed the pump time or changed the active segment
        rec.timed_segment = rec.change_type & 1 ? true : false;
