...
module.exports = function (config) {
    ...
    var tandemDownloadRecords = function (progress, callback) {
        ...
        function iterate(err, result) {
            if (err) {
                ...
                if (result.valid && seq < end_seq) {
                    if (result.descriptor === RESPONSES.LOG_ENTRY_TE.value) {
        ...
        tandemCommandResponse(COMMANDS.LOG_SIZE_REQ, null, function (err, result) {
            if (err) {
                ...
                // seq = result.payload['start_seq']; // limit to 3000 for debugging
                seq = result.payload['end_seq'] - 3000;
    ...
    return {
        ...
        connect: function (progress, data, cb) {
            ...
            cfg.deviceComms.setBitrate(921600);
