...
module.exports = function (config) {
  ...
  var tandemLogRequester = function (start, end, progress, callback) {
    ...
    var start_tandemLog = new Date().getTime();
    var send_seq = start;
          ...
          if (pkt.valid &&
            ...
            if (receive_seq != pkt.payload['header_log_seq_no']) {
              ...
              if(start !== end) {
                ...
                percentage = receive_seq/end * 100;
              ...
              if (receive_seq > end) {
                ...
                var time = end_exec - start_tandemLog;
                console.log('Execution time of tandemLogRequester: ' + time);
