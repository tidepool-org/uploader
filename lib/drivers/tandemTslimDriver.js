...
module.exports = function (config) {
    ...
    var RESPONSES = {
        ...
        125: {
            ...
            version: 36102,
            format: 'i2.hiii16Z',
            fields: ['index', 'header_id', 'header_log_seq_no', 'header_spare', 'type_dep']
        },
        169: {
            // LOG_SIZE_TE
            value: 169,
    ...
    var extractPacket = function (bytes) {
        ...
        console.log('in extractPacket, plen=',plen);
        if (plen < 9) {
        ...
        console.log('pchecksum:', packet.crc);
