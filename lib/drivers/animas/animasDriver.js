...
module.exports = function (config) {
  ...
  function buildSettingsRecord(data, postrecords) {
    ...
    var postsettings = cfg.builder.makePumpSettings()
      ...
      .with_manufacturers(data.settings.manufacturer)
      .with_model(data.settings.modelNumber)
      .with_serialNumber(data.settings.serialNumber)
  ...
  return {
    ...
    getConfigInfo: function (progress, data, cb) {
      ...
      function(err, results){
          if(err) {
            ...
            data.settings.manufacturer = ['Animas'];
            progress(100);
    ...
    uploadData: function (progress, data, cb) {
      ...
      var sessionInfo = {
        ...
        deviceManufacturers: data.settings.manufacturer,
