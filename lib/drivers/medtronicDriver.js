  ...
  var readCurrentCBGPage = function () {
    ...
    return {
      ...
      parser: function (packet) {
        ...
        var currentPage = struct.extractBEInt(medtronicMessage,0) + 1;
    ...
    getConfigInfo: function (progress, data, cb) {
      ...
      function(err, results){
          ...
          if(!err){
              ...
              data.currentCBGPage = results.current_cbg_page.currentPage;
              return cb(null, data);
          } else {
    ...
    fetchData: function (progress, data, cb) {
      ...
      async.series({
        ...
        readCBGHistory : function(callback) {
          readHistoryPages(MESSAGES.READ_CBG_HISTORY, data.currentCBGPage, function(err, results) {
