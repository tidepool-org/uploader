  ...
  var readCurrentPage = function () {
    ...
    return {
      ...
      parser: function (packet) {
        ...
        var currentPage = Math.min(medtronicMessage[3], 36) + 1;
  ...
  var readCurrentCBGPage = function () {
    ...
    return {
      ...
      parser: function (packet) {
        ...
        var currentPage = Math.min(struct.extractBEInt(medtronicMessage,0), 32) + 1;
        var glucose = Math.min(struct.extractByte(medtronicMessage,5), 32) + 1;
        var isig = Math.min(struct.extractByte(medtronicMessage,7), 32) + 1;
