  ...
  return {
    ...
    fetchData: function (progress, data, cb) {
      ...
      async.series({
        ...
        readCBGHistory : function(callback) {
          ...
          readHistoryPages(MESSAGES.READ_CBG_HISTORY, data.cbg.currentPage + data.cbg.glucose , function(err, results) {
        ...
        readISIGHistory : function(callback) {
          ...
          readHistoryPages(MESSAGES.READ_ISIG_HISTORY, data.cbg.currentPage + data.cbg.isig, function(err, results) {
    ...
    processData: function (progress, data, cb) {
      ...
      proc.processPages(data, function (err, records) {
        ...
        proc.processCBGPages(data, function (cbgErr, cbgRecords) {

          if(cbgErr) {
            return cb(cbgErr,data);
          }
          ...
          try {
            ...
            postrecords = postrecords.concat(proc.buildCGMRecords(cbgRecords));
          } catch (err) {
            return cb(err,null);
          }
