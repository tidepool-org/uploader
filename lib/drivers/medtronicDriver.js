    ...
    processData: function (progress, data, cb) {
      ...
      proc.processPages(data, function (err, records) {
        ...
        proc.processCBGPages(data, function (cgmErr, cgmRecords) {
          ...
          var result = proc.buildTimeChangeRecords(records, mostRecent);
          ...
          if(cgmDateRecords.length === 0) {
            ...
            var cgmResult = proc.buildTimeChangeRecords(cgmRecords, cgmMostRecent);
            //postrecords = postrecords.concat(result.postrecords);
