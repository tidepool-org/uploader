    ...
    getConfigInfo: function (progress, data, cb) {
      ...
      async.series({
        ...
        profile_std : function(callback){
          getOneRecord(readProfiles(MESSAGES.READ_PROFILE_STD), false, function(err, result) {
            if(err) {
              return cb(err,null);
            }
        ...
        profile_a : function(callback){
          getOneRecord(readProfiles(MESSAGES.READ_PROFILE_A), false, function(err, result) {
            if(err) {
              return cb(err,null);
            }
        ...
        profile_b : function(callback){
          getOneRecord(readProfiles(MESSAGES.READ_PROFILE_B), false, function(err, result) {
            if(err) {
              return cb(err,null);
            }
