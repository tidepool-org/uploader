  ...
  var readCurrentCBGPage = function () {
    ...
    return {
      ...
      parser: function (packet) {
        ...
        var glucose = Math.min(struct.extractByte(medtronicMessage,5), MAX_CBG_PAGES) + 1;
        var isig = Math.min(struct.extractByte(medtronicMessage,7), MAX_CBG_PAGES) + 1;

        return { currentPage : currentPage, glucose: glucose, isig: isig };
      }
    };
  };
    ...
    getConfigInfo: function (progress, data, cb) {
      ...
      function(err, results){
          ...
          if(!err){
              ...
              data.cbg = _.pick(results.current_cbg_page, ['currentPage','glucose', 'isig']);
              return cb(null, data);
          } else {
    ...
    fetchData: function (progress, data, cb) {
      ...
      async.series({
        ...
        readCBGHistory : function(callback) {
          ...
          readHistoryPages(MESSAGES.READ_CBG_HISTORY, data.cbg.glucose, function(err, results) {
        ...
        readISIGHistory : function(callback) {
          ...
          readHistoryPages(MESSAGES.READ_ISIG_HISTORY, data.cbg.isig, function(err, results) {
