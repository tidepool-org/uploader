  ...
  var readCurrentPage = function () {
    ...
    return {
      ...
      parser: function (packet) {
        ...
        var currentPage = medtronicMessage[3] + 1;
  ...
  var readCurrentCBGPage = function () {
    ...
    return {
      ...
      parser: function (packet) {
        ...
        var glucose = struct.extractByte(medtronicMessage,5);
        var isig = struct.extractByte(medtronicMessage,7);
                  ...
                  if (result) {
                    ...
                    if(result.resultsInReply &&
                      ...
                      if(_sum_lsb(payload) !== checksum || decoded.message.length === 0) {
                        ...
                        return callback(new Error('Communication error. Please try to upload again.'));
                      };
                    }
