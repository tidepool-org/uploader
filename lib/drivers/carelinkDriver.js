...
var csvFormat = require('../carelink/csv/minimed.com');
...
function initializeProcessors(opts) {
  ...
  return [
    ...
    require('../carelink/smbg.js')(_.assign(opts, csvFormat.pumpTypesToRead.BGCapturedOnPump)),
  ...
  return function (config) {
    ...
    return {
      ...
      processData: function (progress, payload, cb) {
        ...
        colNames.fingerstickGlucose = findColName('Sensor Calibration BG');
