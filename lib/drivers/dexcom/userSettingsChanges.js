 ...
 module.exports = function(settings, opts) {
  ...
  for (var i = 0; i < settings.length; ++i) {
    ...
    if (rec.internalTime.slice(0,4) !== '2009') {
      ...
      // ignores records with a transmitterId of `60000` or `400000` (default, not yet set up)
      if (rec.setUpState >= 5 && convertTransmitterId(rec.transmitterId) !== '60000' && rec.transmitterId !== '400000' && rec.transmitterId !== '888888') {
