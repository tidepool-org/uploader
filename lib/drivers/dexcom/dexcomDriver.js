...
module.exports = function (config) {
  ...
  cfg.deviceTags = ['cgm'];
  cfg.deviceManufacturers = ['Dexcom'];
            ...
            getPartitionInfo(true, function(partErr, obj) {
              if (partErr) {
                ...
                do_ping(function (err, result) {
                  ...
                  cfg.deviceModel = data.deviceModel;
                  cb(null, data);
                });
              }
            });
          ...
          if (displayErr) {
            ...
            getSystemTime(true, function(systemErr, systemTimeObj) {
              if (systemErr) {
                ...
                data.displayTime = new Date(BASE_DATE_DEVICE + 1000 * (systemTimeObj.parsed_payload + displayTimeOffsetObj.parsed_payload));
                common.checkDeviceTime(data.displayTime, cfg, function(err) {
                  progress(100);
