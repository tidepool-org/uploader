...
export class KetoMojo extends EventTarget {
  ...
  static buildPacket(payload) {
    ...
    let ctr = struct.pack(bytes, 0, 'bbbbbbbbbbbbbbb',
      BEGIN, 0x01, TARGET_CODE, 0x01, SOURCE_CODE,
      payload, EXTENDED_CODE_READ,
      0x00, 0x01, 0x01, 0x04, 0x03, 0x07, 0x07, END )
  ...
  async getSerial() {
    ...
    await this.writeCharacteristic.writeValue(KetoMojo.buildPacket(COMMAND_READ_SERIAL));
  }
