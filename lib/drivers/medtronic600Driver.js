    ...
    fetchData(progress, data, cb) {
      ...
      driver.getCnlInfo()
        ...
        .then(() => driver.readHistory(
          // threeMonthsAgo = new Date(new Date().valueOf() - 7776e6);
          // settings.currentNgpTimestamp.rtcFromDate(new Date('2016-07-01T00:00:00')),
          // settings.currentNgpTimestamp.rtcFromDate(new Date('2016-12-01T00:00:00')),
          settings.currentNgpTimestamp.rtcFromDate(new Date('2017-03-01T00:00:00')),
