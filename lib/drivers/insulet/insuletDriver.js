...
module.exports = function (config) {
  ...
  cfg.deviceManufacturers = ['Insulet'];
  ...
  var buildSettingsRecord = function (data, records) {
    ...
    var postsettings = cfg.builder.makePumpSettings()
      ...
      .with_manufacturers(cfg.deviceManufacturers)
  ...
  return {
    ...
    getConfigInfo: function (progress, data, cb) {
      ...
      if (isElectron()) {
        cfg.deviceModel = data.ibf_version.productid;
    ...
    uploadData: function (progress, data, cb) {
      ...
      var sessionInfo = {
        ...
        deviceManufacturers: cfg.deviceManufacturers,
