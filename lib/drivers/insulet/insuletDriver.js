...
module.exports = (config) => {
    ...
    for (let b = 0; b < bolusrecs.length; ++b) {
      ...
      if (isDash && hasFlag(LOG_FLAGS.CARRY_OVER_FLAG, bolus.flags)) {
        ...
        if (sugg_calc && sugg_calc.hours > 0) {
          ...
          // to assume that the offset was not calculated correctly
  ...
  return {
    ...
    uploadData(progress, data, cb) {
      ...
      console.log(JSON.stringify(data.post_records, null, 4)); // TODO: remove this
