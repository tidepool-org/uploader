...
module.exports = function (config) {
  ...
  var tzoUtil = new TZOUtil(cfg.timezone, new Date().toISOString(), []);
  cfg.tzoLookup = tzoUtil.lookup;
  ...
  function parseDateTime(match, index) {
    ...
    var utcInfo = cfg.tzoLookup(parsed);
    return { dev: dev, utc: utcInfo.time, offset: utcInfo.timezoneOffset };
  }
