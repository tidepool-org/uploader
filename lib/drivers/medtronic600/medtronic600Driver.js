...
class MM600SeriesDriver extends BCNLDriver {
  ...
  static convertSerialToMacID(pumpSerial = 'NG1135742H') {
    ...
    const num2 = isFinite(str.charAt(3)) ? 1000000 * parseInt(str.charAt(3), 10) +
    ...
    return common.bytes2hex(numArray, true);
  }
