  ...
  return {
    ...
    getConfigInfo(progress, data, cb) {
      ...
      (async () => {
        ...
        data.deviceModel = data.settings.pumpModel; // for metrics
        data.deviceTime = sundial.formatDeviceTime(pumpTime.time.toDate());
        ...
        common.checkDeviceTime(data.deviceTime, cfg, (err) => {
          progress(100);
          cb(err, data);
        });
      })().catch((error) => {
