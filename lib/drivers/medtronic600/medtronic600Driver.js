...
class NGPRequest extends NGPMessage {
  ...
  async send(hidDevice, readTimeout = NGPMessage.READ_TIMEOUT_MS, get80response = true) {
    await this.sendMessage(hidDevice);
...
class TransmitPacketRequest extends NGPRequest {
  ...
  send(hidDevice, readTimeout = NGPMessage.READ_TIMEOUT_MS, get80response = true) {
...
class HighSpeedModeCommand extends TransmitPacketRequest {
  ...
  send(hidDevice, readTimeout = NGPMessage.READ_TIMEOUT_MS, get80response = false) {
    return super.send(hidDevice, readTimeout, get80response);
  }
}
