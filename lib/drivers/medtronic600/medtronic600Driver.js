...
const ExtendableError = require('es6-error').default;
const uploadDataPeriod = require('../../../app/utils/uploadDataPeriod');
const crcCalculator = require('@tidepool/uploader-common/crc');
...
// only load lzo-wasm in the browser/electron, we don't need it for cli
// eslint-disable-next-line import/no-extraneous-dependencies
const LZO = isBrowser ? require('lzo-wasm') : null;
