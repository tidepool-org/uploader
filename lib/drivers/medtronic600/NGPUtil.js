...
class NGPConstants {
  ...
  static get CL_TRANSITION_REASON() {
    return {
      INTO_ACTIVE_DUETO_GLUCOSE_SENSOR_CALIBRATION: 0,
      OUTOF_ACTIVE_DUETO_USER_OVERRIDE: 1,
      OUTOF_ACTIVE_DUETO_ALARM: 2,
      OUTOF_ACTIVE_DUETO_TIMEOUT_FRM_SAFE_BASAL: 3,
      OUTOF_ACTIVE_DUETO_PROLONGED_HIGH_SG: 4,
    };
  }
