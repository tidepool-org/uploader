...
const difflet = require('difflet'); // TODO: remove this
...
class Medtronic600Simulator {
  ...
  pumpSettings(event) {
    console.log(difflet.compare(_.omit(this.currPumpSettings, ['index', 'time', 'payload']), _.omit(event, ['index', 'time', 'payload'])));
    this.simpleSimulate(event);
