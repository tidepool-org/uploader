...
const builder = require('../../../objectBuilder.js')();
const medtronic600Driver = require('../../../drivers/medtronic600/medtronic600Driver');
  ...
  fs.readFile(filePath, 'utf8', (error, data) => {
    ...
    const cfg = {
      Medtronic600: {
        ...
        builder,
        api,
        deviceInfo: { deviceId: `${json.settings.pumpModel}:${json.settings.pumpSerial}` },
      },
    };
