...
=======
      ...
      return false;
>>>>>>> 8b76e1a4f2cd61c43e1d414ab9a9bffeabffbb6f
    }
...
>>>>>>> 8b76e1a4f2cd61c43e1d414ab9a9bffeabffbb6f
    ...
    for (let i = 0; i < payload.length; i += 28) {
      ...
      const deviceSn = uintFromArrayBuffer(SN, true);
    ...
    buildBasalSchedules(settings) {
      ...
      for (let c = 0; c < choList.length; c++) {
        if (c == 0) {
          ...
          let choLgth = carbRatio.length;
          if (choList[c] != carbRatio[choLgth - 1]) {
            carbRatio.push({
              amount: choList[c] / 10,
              start: c * 30 * 60 * 1000,
            });
...
>>>>>>> 8b76e1a4f2cd61c43e1d414ab9a9bffeabffbb6f
          ...
          let senLgtn = insulinSensitivity.length;
          if (senList[c] != insulinSensitivity[senLgtn - 1]) {
            insulinSensitivity.push({
              amount: senList[c] / 10,
              start: c * 30 * 60 * 1000,
            });
      ...
      for (let c = 0; c < bgList.length; c++) {
        if (c == 0) {
          ...
          let targetLength = bgTarget.length;
          if (bgList[c] != bgTarget[targetLength - 1].low || bgHighList[c] != bgTarget[targetLength - 1].high) {
            bgTarget.push({
              start: c * 30 * 60 * 1000,
              low: bgList[c] / 10,
...
<<<<<<< HEAD
        postRecord.deviceId = cfg.deviceInfo.deviceId;
=======
>>>>>>> 8b76e1a4f2cd61c43e1d414ab9a9bffeabffbb6f
        res.push(postRecord);
      }
...
<<<<<<< HEAD
          postbolus.deviceId = cfg.deviceInfo.deviceId;
=======
>>>>>>> 8b76e1a4f2cd61c43e1d414ab9a9bffeabffbb6f
