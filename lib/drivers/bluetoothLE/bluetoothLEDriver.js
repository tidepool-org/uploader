...
module.exports = (config) => {
  ...
  return {
   ...
   fetchData(progress, data, cb) {
     ...
     cfg.deviceComms.ble.once('numberOfRecords', async (result) => {
   ...
   cleanup(progress, data, cb) {
     ...
     (async () => {
       cfg.deviceComms.ble.removeAllListeners('data');
       cfg.deviceComms.ble.removeAllListeners('numberOfRecords');
