...
/**
 * Extracts the provided fields (see extract()) and converts them to a Boolean.
 *
 * @param fieldFn a function that can extract a field, or an object that can be passed to extract()
 * @param defaultVal optional, the value to return when the field is null
 * @returns {Function} a function that will extract the given field and convert it to a boolean when passed an object
 */
exports.asBoolean = function(fieldFn, defaultVal) {
  return exports.map(fieldFn, function(e) {
    if (e == null) {
      if (defaultVal == null) {
        return null;
      ...
      return {
        ...
        apply: function(parserFn) {
          if (handler.parserFn == null) {
            ...
            handler.parserFn = _.flowRight(parserFn, handler.parserFn);
          }
          return this;
        },
