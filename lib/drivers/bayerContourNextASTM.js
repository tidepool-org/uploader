...
var debug = isBrowser ? require('../bows')('BCNextASTMDriver') : debug;
...
module.exports = function (config) {
  ...
  var extractPacketIntoFrame = function (bytes) {
    ...
    var packetTail = struct.unpack(astmFrameBuffer.bytes, astmFrameBuffer.frame_len - 6, '2bS2b', ['CR1', 'FRAME_TYPE', 'CHECKSUM', 'CR2', 'LF']);
  ...
  var getASTMFrame = function (timeout, retries, callback) {
    ...
    var listenTimer = setInterval(function () {
      hidDevice.receive(function(raw) {
        ...
        var packetTail = struct.unpack(packet, parseInt(packetHead['SIZE']) - 2, '2bS2S', ['CR', 'FRAME_TYPE', 'CHECKSUM', 'CRLF']);
        switch(packetTail['FRAME_TYPE']) {
          case ASCII_CONTROL.ETX: // Last ASTM Frame
          case ASCII_CONTROL.ETB: // End of valid ASTM Frame
            clearTimeout(abortTimer);
