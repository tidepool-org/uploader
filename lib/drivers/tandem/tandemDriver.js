...
module.exports = function (config) {
  ...
  var CGM_GXB_TYPE = {
    FMR : { value: 0, name: 'Five Minute Reading (FMR)'},
    BACKFILL : { value: 1, name: 'Backfill'},
    IMV: { value: 2, name: 'Immediate Match Value'},
    CALIBRATION: { value: 3, name: 'Calibration'},
    NONE: {value: 4, name: 'None'}
  };
