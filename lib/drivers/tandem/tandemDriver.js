...
module.exports = function (config) {
  ...
  cfg.deviceManufacturers = ['Tandem'];
  ...
  var tandemGetConfigInfo = function (cb, data) {
    tandemCommandResponse(COMMANDS.VERSION_REQ, null, function (err, result) {
      if (err) {
        ...
        data.deviceInfo.deviceId = 'tandem' + data.deviceModel + data.pump_sn;
        ...
        data.deviceTime = currentTime.deviceTime;

        cfg.deviceModel = data.deviceModel;
        common.checkDeviceTime(data.deviceTime, cfg, function(err) {
          return cb(err, data);
        });
      }
    });
