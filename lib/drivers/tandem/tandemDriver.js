  ...
  return {
    ...
    uploadData: function (progress, data, cb) {
      ...
      */
      ...
      api.getLatestRecord(cfg.groupId, cfg.deviceInfo.deviceId, 'basal', function(err, latestBasal) {
        if (err) {
          return cb(err);
        }

        debug('Last basal from previous upload was: ', JSON.stringify(_.pick(latestBasal, 'time', 'deviceTime', 'deliveryType', 'rate', 'scheduleName', 'annotations'), null, 4));
