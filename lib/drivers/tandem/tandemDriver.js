...
module.exports = function (config) {
  ...
  var buildSuspendRecords = function (data, records) {
    ...
    suspendRecords.forEach(function (entry) {
      var postrecord = cfg.builder.makeDeviceEventSuspendResume()
  ...
  return {
    ...
    processData: function (progress, data, callback) {
    ...
    uploadData: function (progress, data, cb) {
      ...
      */
      ...
      common.updatePreviousDurations(data, cfg, function(err, data) {
        if (err) {
          return cb(err);
        }
