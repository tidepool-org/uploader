  ...
  return {
    ...
    finalize: function() {
      ...
      if (currPumpSettingsOverride && currPumpSettingsOverride.overrideType !== 'normal') {
        if (!currPumpSettingsOverride.isAssigned('duration')) {
          ...
          annotate.annotateEvent(currPumpSettingsOverride, 'tandem/fabricated-duration');
        }
    ...
    newDay: function(event) {
      ...
      if (currPumpSettingsOverride && currPumpSettingsOverride.overrideType !== 'normal') {
        ...
        annotate.annotateEvent(modeChange, 'tandem/deviceEvent/fabricated-from-new-day');
        // TODO: add new annotations to tideline
    ...
    pumpSettingsOverride: function(event) {
      if (currPumpSettingsOverride) {
        ...
        if (duration <  604800000) {
          ...
          annotate.annotateEvent(modeChange, 'tandem/fabricated-duration');
