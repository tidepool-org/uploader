...
module.exports = function (config) {
  ...
  var ALARM_TYPES = {
    ALARM_PDM_ERROR0: { value: 0, name: 'AlrmPDM_ERROR0' },
    ALARM_PDM_ERROR1: { value: 1, name: 'AlrmPDM_ERROR1' },
    ALARM_PDM_ERROR2: { value: 2, name: 'AlrmPDM_ERROR2' },
    ALARM_PDM_ERROR3: { value: 3, name: 'AlrmPDM_ERROR3' },
    ALARM_PDM_ERROR4: { value: 4, name: 'AlrmPDM_ERROR4' },
    ALARM_PDM_ERROR5: { value: 5, name: 'AlrmPDM_ERROR5' },
    ALARM_PDM_ERROR6: { value: 6, name: 'AlrmPDM_ERROR6' },
    ALARM_PDM_ERROR7: { value: 7, name: 'AlrmPDM_ERROR7' },
    ALARM_PDM_ERROR8: { value: 8, name: 'AlrmPDM_ERROR8' },
    ALARM_PDM_ERROR9: { value: 9, name: 'AlrmPDM_ERROR9' },
    ALARM_SYSTEM_ERROR10: { value: 10, name: 'AlrmSYSTEM_ERROR10' },
    ALARM_SYSTEM_ERROR12: { value: 12, name: 'AlrmSYSTEM_ERROR12' },
    ALARM_HAZ_REMOTE: { value: 13, name: 'AlrmHAZ_REMOTE' },
    ALARM_HAZ_PUMP_VOL: { value: 14, name: 'AlrmHAZ_PUMP_VOL' },
    ALARM_HAZ_PUMP_AUTO_OFF: { value: 15, name: 'AlrmHAZ_PUMP_AUTO_OFF' },
    ALARM_HAZ_EXPIRED: { value: 16, name: 'AlrmHAZ_EXPIRED' },
    ALARM_HAZ_OCCL: { value: 17, name: 'AlrmHAZ_OCCL' },
    ALARM_HAZ_ACTIVATE: { value: 18, name: 'AlrmHAZ_ACTIVATE' },
    ALARM_KEY: { value: 21, name: 'AlrmKEY' },
    ALARM_ADV_PUMP_VOL: { value: 23, name: 'AlrmADV_PUMP_VOL' },
    ALARM_ADV_PUMP_AUTO_OFF: { value: 24, name: 'AlrmADV_PUMP_AUTO_OFF' },
    ALARM_ADV_PUMP_SUSPEND: { value: 25, name: 'AlrmADV_PUMP_SUSPEND' },
    ALARM_ADV_PUMP_EXP1: { value: 26, name: 'AlrmADV_PUMP_EXP1' },
    ALARM_ADV_PUMP_EXP2: { value: 27, name: 'AlrmADV_PUMP_EXP2' },
    ALARM_SYSTEM_ERROR28: { value: 28, name: 'AlrmSYSTEM_ERROR28' },
    ALARM_EXPIRATION: { value: 37, name: 'AlrmEXPIRATION' },
    ALARM_PDM_AUTO_OFF: { value: 39, name: 'AlrmPDM_AUTO_OFF' }
  };
  ...
  var findPumpAlarmRecords = function (recordlist) {
    var result = [];
    for (var i = 0; i < recordlist.length; ++i) {
      // TODO: check with KJQ about log_index of -1???
      // doesn't have a timestamp, so I think it's not a valid record
  ...
  var buildAlarmRecords = function (data, records) {
    ...
    function makeSuspended(anAlarm) {
      return cfg.builder.makeDeviceMetaSuspend()
        .with_time(anAlarm.timestamp)
        .with_deviceTime(anAlarm.deviceTime)
        .with_timezoneOffset(anAlarm.timezoneOffset)
        .with_reason('automatic')
        .done();
    }
    ...
    function makeSuspendBasal(anAlarm) {
      ...
      return cfg.builder.makeSuspendBasal()
        .with_time(anAlarm.timestamp)
        .with_deviceTime(anAlarm.deviceTime)
        .with_timezoneOffset(anAlarm.timezoneOffset);
    }
    ...
    for (var a = 0; a < alarmrecs.length; ++a) {
      ...
      postalarm = cfg.builder.makeDeviceMetaAlarm()
        .with_time(alarm.timestamp)
        .with_deviceTime(alarm.deviceTime)
        .with_timezoneOffset(alarm.timezoneOffset);
      ...
      switch (alarmValue) {
        ...
        case 21:
          postalarm = postalarm.with_alarmType('other')
            .with_payload({
              ...
              explanation: 'PDM stuck key detected',
              stopsDelivery: false
            })
            .done();
          break;
        case 37:
          postalarm = postalarm.with_alarmType('other')
            .with_payload({
              alarmText: getNameForValue(ALARM_TYPES, alarmValue),
              explanation: 'pod expiration advisory',
              stopsDelivery: false
            })
            .done();
          break;
        ...
        case 14:
          ...
          break;
        case 15:
        // TODO: clarify with Insulet or get data to figure out whether this is
        ...
        case 17:
          ...
          postalarm = postalarm.with_alarmType('occlusion')
            .with_payload({
              alarmText: getNameForValue(ALARM_TYPES, alarmValue),
              explanation: 'pump site occluded',
              stopsDelivery: true
            })
            .with_status(postsuspend)
            .done();
        ...
        case 18:
          postalarm = postalarm.with_alarmType('other')
            .with_payload({
              alarmText: getNameForValue(ALARM_TYPES, alarmValue),
              explanation: 'pod is a lump of coal',
              stopsDelivery: false
            })
            .done();
          break;
        case 23:
          postalarm = postalarm.with_alarmType('low_insulin')
            .with_payload({
              alarmText: getNameForValue(ALARM_TYPES, alarmValue),
              explanation: 'low reservoir',
              stopsDelivery: false
              // TODO: can we look up in settings to see what the low reservoir
              // alert setting is? possibly that belongs in simulator
            })
            .done();
          break;
        case 24:
        ...
        // a warning or the actual auto-off; the spec is confused
          postalarm = postalarm.with_alarmType('other')
            .with_payload({
              alarmText: getNameForValue(ALARM_TYPES, alarmValue),
              explanation: '15 minutes to auto-off warning',
              stopsDelivery: false
            })
            .done();
          break;
        ...
        case 27:
          postalarm = postalarm.with_alarmType('other')
            .with_payload({
              alarmText: getNameForValue(ALARM_TYPES, alarmValue),
              explanation: 'pod expiration alert',
              stopsDelivery: false
            })
            .done();
          break;
  ...
  return {
    ...
    uploadData: function (progress, data, cb) {
        ...
        switch (datum.type) {
          ...
          case 'deviceMeta':
            if (datum.subType === 'status') {
              ...
              debug('deviceMeta of type %s not passed to simulator!', datum.type);
            }
            break;
          case 'settings':
      ...
      var sessionInfo = {
        ...
        deviceSerialNumber: data.eeprom_settings.REMOTE_ID,
