  ...
  return {
    ...
    getConfigInfo(progress, data, cb) {
      ...
      (async () => {
        ...
        data.deviceInfo.deviceId = `Roche-${cfg.deviceModel}-${data.deviceInfo.serial}`;
        ...
        data.deviceTime = sundial.formatDeviceTime(data.deviceInfo.meterTime);
