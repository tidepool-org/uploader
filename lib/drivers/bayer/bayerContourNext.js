  ...
  var setDateTime = function(serverTime, cb) {
    ...
    async.series({
      ...
      eot: function(callback) {
        // The Contour Next One and Ascensia Contour Next meters do not expect EOT here
        if ((cfg.deviceInfo.model !== 'Contour Next One') && (cfg.deviceInfo.modelNumber !== 'Contour7900')) {
