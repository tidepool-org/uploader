      ...
      async.whilst(
        ...
        function (err) {
          ...
          if(err || error) {
            ...
            cfg.deviceModel = MODELS[data.model];
            if(cfg.deviceModel == null) {
              cfg.deviceModel = 'Unknown Bayer model';
            }
            debug('Detected as: ', cfg.deviceModel);
