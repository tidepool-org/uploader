...
module.exports = function (config) {
  ...
  */
  ...
  var getOneRecord = function (data, transferMode, callback) {
    var retry = 0;
    var robj = {};
...
/*
      reconnect : function(callback) {
        cfg.deviceComms.disconnect([], function() {
          cfg.deviceComms.connect(cfg.deviceInfo, probe, function() {
...
*/
      ...
      ack : function(callback){
        ...
        bcnCommandResponse(buildAckPacket(), function (err, result) {
          if(err) {
            return cb(err,null);
          }
      ...
      eot : function(callback){
        ...
        bcnCommandResponse(buildPacket([ASCII_CONTROL.EOT],1), function (err, result) {
          if(err) {
            return cb(err,null);
          }
      ...
      x : function(callback){
        ...
        bcnCommandResponse(buildPacket([0x58],1), function (err, result) {
          if(err) {
            return cb(err,null);
          }
...
*/
      nak : function(callback){
        function sendNAK(cb) {
          console.log("sending nak");
          bcnCommandResponse(buildPacket([ASCII_CONTROL.NAK], 1), function(err, result) {
            if(err) {
              return cb(err,null);
            }
    ...
    /*
      ...
      can : function(callback){
        console.log("sending can");
        bcnCommandResponse(buildPacket([ASCII_CONTROL.CAN], 1), function(err, result) {
          if(err) {
            return cb(err,null);
          }
          if(result.messageType !== ASCII_CONTROL.EOT) {
...
*/
      enq : function(callback){
        ...
        bcnCommandResponse(buildPacket([ASCII_CONTROL.ENQ], 1), function(err, result) {
          if(err) {
            return cb(err,null);
          }
...
*/
      write : function(callback){
        ...
        bcnCommandResponse(buildPacket(COMMANDS.WRITE, 2), function(err, result) {
          if(err) {
            return cb(err,null);
          }
      ...
      date : function(callback){
        ...
        bcnCommandResponse(buildPacket(COMMANDS.DATE, 2), function(err, result) {
          if(err) {
            return cb(err,null);
          }
          if(result.messageType !== ASCII_CONTROL.ACK) {
      ...
      setDate: function(callback){
        console.log("sending actual date");
        bcnCommandResponse(buildPacket(sundial.formatInTimezone(serverTime, cfg.timezone, 'YYMMDD|') + String.fromCharCode(13), 8), function(err, result) {
          if(err) {
            return cb(err,null);
          }
          if(result.messageType !== ASCII_CONTROL.ACK) {
  ...
  return {
    ...
    getConfigInfo: function (progress, data, cb) {
      ...
      getOneRecord(data, true, function (err, result) {
          progress(100);
          if (!err) {
            data.connect = true;
