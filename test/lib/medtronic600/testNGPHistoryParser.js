...
describe('NGPHistoryParser.js', () => {
  ...
  describe('wizard', () => {
    test(
      'should add bolus record with matching programmed event to wizard',
      () => {
    ...
    test(
      'should ignore a bolus record without a matching programmed event',
      () => {
  ...
  describe('temp basal', () => {
    test(
      'should not create a temp basal event if a TEMP_BASAL_COMPLETE has no corresponding TEMP_BASAL_PROGRAMMED',
      () => {
    ...
    test(
      'should not create a temp basal event if a corresponding suppressed basal cannot be found',
      () => {
    ...
    test(
      'should create a temp basal event when all required pump history events are found',
      () => {
    ...
    test(
      'should synthesize a temp basal with annotations if final temp basal event is TEMP_BASAL_PROGRAMMED',
      () => {
